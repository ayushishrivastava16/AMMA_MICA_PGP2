...
fitted.results.model1 <- predict(full.model1, newdata=df.test,type='response')
fitted.results.model1 <- ifelse(fitted.results.model1 > 0.5,1,0)
misClasificError <- mean(fitted.results.model1 != df.test$yact)
